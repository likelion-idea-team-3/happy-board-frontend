        ...
        <div className="signup-form-container">
            ...
            >
                <div className="modal-content">
                    ...
                    <p>
                        @@@에서 제공하는 이벤트 및 서비스(제휴 서비스 포함) 안내
                        등 광고성 정보를 받으시려면 혜택 정보 이용에 동의하여
                        주시기 바랍니다.
                    </p>
                    <table className="modal-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    목적 달성 후 즉시 파기, 관련 법령에서 별도의
                                    보관기간을 정한 경우 해당 시점까지 보관
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    <p>
                        동의를 거부할 권리가 있으며, 혜택 등의 여부와 관계 없이
                        회원가입을 할 수 있습니다. 다만, 동의 거부 시 상기
                        목적에 명시된 서비스를 제공받으실 수 없습니다.
                    </p>
                    <button className="close-btn" onClick={togglePromoModal}>
                        닫기
                    </button>
                </div>
            </Modal>
            ...
            >
                <div className="modal-content">
                    ...
                    <p>
                        ㈜@@@은 다음과 같이 개인 정보를 수집 및 이용하고
                        있습니다.
                    </p>
                    <h3>[필수] 개인 정보 수집 및 이용 동의</h3>
                    <ul>
                        <li>
                            <b>1. 개인 정보 수집/이용 목적:</b> @@@ 회원제
                            서비스 제공
                        </li>
                        <li>
                            <b>2. 수집하는 항목:</b> 휴대폰 번호(휴대폰으로 회원
                            가입 시), 이메일(이메일로 회원 가입 시), 비밀번호
                        </li>
                        <li>
                            <b>3. 보유 및 이용 기간:</b> 회원 탈퇴 후 지체 없이
                            삭제(법령에 특별한 규정이 있을 경우 관련 법령에
                            따름)
                        </li>
                    </ul>
                    <p>
                        서비스 이용과정에서 기기 정보, IP 주소, 쿠키, 서비스
                        이용 기록이 자동으로 수집될 수 있습니다.
                    </p>
                    <p>동의를 거부하실 경우 서비스 이용이 불가능합니다.</p>
                    <button className="close-btn" onClick={togglePrivacyModal}>
                        닫기
                    </button>
                </div>
            </Modal>
            ...
            >
                <div className="modal-content">
                    <h2>이용약관 동의</h2>
                    <p>
                        서비스 이용을 위한 이용약관을 확인하시고 동의해 주세요.
                    </p>
                    <ul>
                        <li>
                            <b>1. 이용약관 목적:</b> 서비스 이용 조건 및 절차
                            명시
                        </li>
                        <li>
                            <b>2. 주요 내용:</b> 계정 생성, 서비스 사용, 권리 및
                            의무 등
                        </li>
                        <li>
                            <b>3. 준수 사항:</b> 타인의 권리 침해 금지, 허위
                            정보 제공 금지 등
                        </li>
                    </ul>
                    <p>
                        이용약관에 동의하지 않으시면 서비스 이용이 불가능합니다.
                    </p>
                    <button className="close-btn" onClick={toggleTermsModal}>
                        닫기
                    </button>
                </div>
            </Modal>
